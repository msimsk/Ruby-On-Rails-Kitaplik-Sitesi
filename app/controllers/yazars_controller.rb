class YazarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @yazar.save
        format.html { redirect_to @yazar, notice: 'Yazar eklendi.' }
  ...
  def update
    respond_to do |format|
      if @yazar.update(yazar_params)
        format.html { redirect_to @yazar, notice: 'Yazar düzenlendi.' }
  ...
  def destroy
    @yazar.destroy
    respond_to do |format|
      format.html { redirect_to yazars_url, notice: 'Yazar silindi.' }
